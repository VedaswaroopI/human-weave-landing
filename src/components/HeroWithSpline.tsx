    ...
    >
      ...
      <Card className="relative w-full min-h-[calc(85vh-80px)] bg-background/80 dark:bg-background/95 backdrop-blur-xl border-border/40 shadow-2xl mx-4 sm:mx-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 h-full items-center p-6 md:p-12 lg:p-16">
          ...
          <motion.div 
            className="relative z-10 flex flex-col justify-center space-y-6 lg:space-y-8 order-2 lg:order-1"
          ...
          >
            ...
            <div 
              className="relative h-full rounded-2xl overflow-hidden border border-border/50 bg-muted/30 dark:bg-muted/10 backdrop-blur-sm shadow-inner"
              role="img"
            ...
            {!prefersReducedMotion && (
              <>
                ...
                <div className="absolute -top-6 -left-6 w-24 h-24 bg-secondary/20 dark:bg-secondary/30 rounded-full blur-2xl animate-pulse" style={{ animationDelay: "700ms" }} aria-hidden="true" />
              </>
            )}
          </motion.div>
        </div>
      ...
      <button
        ...
        className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 animate-bounce focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded-full p-2 hover:bg-muted/50 transition-colors"
