...
const EcommerceQATesting = () => {
  const study = allCaseStudies.find(s => s.slug === "ecommerce-qa-testing");
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
              ...
              <div className="glassmorphic bg-card/50 p-4 rounded-xl border border-border">
                <p className="text-3xl font-bold gradient-text animate-gradient">387</p>
                <p className="text-sm text-muted-foreground">Bugs Found</p>
              </div>
              <div className="glassmorphic bg-card/50 p-4 rounded-xl border border-border">
                <p className="text-3xl font-bold gradient-text animate-gradient">34%</p>
                <p className="text-sm text-muted-foreground">Conversion Lift</p>
              </div>
              <div className="glassmorphic bg-card/50 p-4 rounded-xl border border-border">
                <p className="text-3xl font-bold gradient-text animate-gradient">$8.2M</p>
...
export default EcommerceQATesting;
