...
const GlobalSaaSLocalization = () => {
  const study = allCaseStudies.find(s => s.slug === "global-saas-localization");
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
              ...
              <div className="glassmorphic bg-card/50 p-4 rounded-xl border border-border">
                <p className="text-3xl font-bold gradient-text animate-gradient">20</p>
                <p className="text-sm text-muted-foreground">Markets</p>
              </div>
              <div className="glassmorphic bg-card/50 p-4 rounded-xl border border-border">
                <p className="text-3xl font-bold gradient-text animate-gradient">150K+</p>
                <p className="text-sm text-muted-foreground">Words</p>
              </div>
              <div className="glassmorphic bg-card/50 p-4 rounded-xl border border-border">
                <p className="text-3xl font-bold gradient-text animate-gradient">90</p>
...
export default GlobalSaaSLocalization;
