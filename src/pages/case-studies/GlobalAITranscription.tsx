...
const ImagePlaceholder: React.FC<{ alt: string; className?: string }> = ({ alt, className }) => (
...
const GlobalAITranscription = () => {
  const study = allCaseStudies.find(s => s.slug === "global-ai-transcription");
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
              ...
              <div className="glassmorphic bg-card/50 p-4 rounded-xl border border-border">
                <p className="text-3xl font-bold gradient-text animate-gradient">99%</p>
                <p className="text-sm text-muted-foreground">Accuracy</p>
              </div>
              <div className="glassmorphic bg-card/50 p-4 rounded-xl border border-border">
                <p className="text-3xl font-bold gradient-text animate-gradient">3</p>
                <p className="text-sm text-muted-foreground">Languages</p>
              </div>
              <div className="glassmorphic bg-card/50 p-4 rounded-xl border border-border">
                <p className="text-3xl font-bold gradient-text animate-gradient">12</p>
                <p className="text-sm text-muted-foreground">Week Delivery</p>
              </div>
            </div>
          </div>
        </div>
...
export default GlobalAITranscription;
