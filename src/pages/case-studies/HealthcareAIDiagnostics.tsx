...
const HealthcareAIDiagnostics = () => {
  const study = allCaseStudies.find(s => s.slug === "healthcare-ai-diagnostics");
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
              ...
              <div className="glassmorphic bg-card/50 p-4 rounded-xl border border-border">
                <p className="text-3xl font-bold gradient-text animate-gradient">2M</p>
                <p className="text-sm text-muted-foreground">Images</p>
              </div>
              <div className="glassmorphic bg-card/50 p-4 rounded-xl border border-border">
                <p className="text-3xl font-bold gradient-text animate-gradient">100%</p>
                <p className="text-sm text-muted-foreground">HIPAA-Compliant</p>
              </div>
              <div className="glassmorphic bg-card/50 p-4 rounded-xl border border-border">
                <p className="text-3xl font-bold gradient-text animate-gradient">8</p>
...
export default HealthcareAIDiagnostics;
